...
function Home() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="max-w-full mx-8 md:max-w-md border border-black p-6 rounded-lg">
        <p>
          ...
          deserves a chance to be looked at! You may keep "swiping" to get a new
          dog or cat, generated randomly. If you feel like they may be the one,
          you have the option to find out more about them!{" "}
        </p>
      </div>
    </div>
  );
